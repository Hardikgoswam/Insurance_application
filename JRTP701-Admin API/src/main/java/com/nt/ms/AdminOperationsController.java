...
public class AdminOperationsController {
	...
	public ResponseEntity<String> changeStatusByPlanId(@PathVariable Integer planId, @PathVariable String status) {
		// use service
	 ...
	 * ResponseEntity<ExceptionInfo> handleIAE(IllegalArgumentException iae){
	 * ExceptionInfo info=new ExceptionInfo(); info.setMessage(iae.getMessage());
	 * info.setCode(3000); return new
	 * ResponseEntity<ExceptionInfo>(info,HttpStatus.INTERNAL_SERVER_ERROR); }
	 */
